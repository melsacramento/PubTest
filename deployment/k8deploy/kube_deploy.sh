...
main() {
  ...
  curl -L https://raw.githubusercontent.com/melsacramento/PubTest/main/deployment/k8deploy/kube_script.sh -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
