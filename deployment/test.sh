...
main() {
  ...
  curl -L https://raw.githubusercontent.com/melsacramento/PubTest/main/deployment/edge.yml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
